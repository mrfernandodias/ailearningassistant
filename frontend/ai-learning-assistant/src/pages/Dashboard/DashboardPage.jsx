...
const DashboardPage = () => {
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-slate-50/80 backdrop-blur-sm z-50 animate-in fade-in duration-200">
        <Spinner />
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 text-sm">No dashboard available</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen relative">
      <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none z-0"></div>
                  ...
                  >
                    ...
                    {activity.link && (
                      <a
                        ...
                        aria-label={`View ${activity.type} ${activity.description}`}
                      >
                        View
                      </a>
                    )}
