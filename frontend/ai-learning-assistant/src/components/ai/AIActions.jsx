...
const AIActions = () => {
  ...
  const handleGenerateSummary = async () => {
    ...
    try {
      const payload = await aiService.generateSummary(documentId);
  ...
  const handleExplainConcept = async (e) => {
    ...
    try {
      const payload = await aiService.explainConcept(documentId, concept);
      ...
      console.error('Error to explain concept:', error);
    } finally {
      setLoadingAction(null);
    }
  };
  ...
  return (
    <>
          ...
          <div className="group p-5 bg-gradient-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="shrink-0 h-11 px-5 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
              >
          ...
          <div className="group p-5 bg-gradient-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
            <form onSubmit={handleExplainConcept}>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  type="submit"
                  className="shrink-0 h-11 px-5 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-600 hover:to-emerald-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
      ...
      {/* Result Modal (inline, padrão do app) */}
      {isModalOpen && (
        <div
